...
class _$FirebaseUserTearOff {
  ...
  _FirebaseUser call({required UniqueId id, required User firebaseUser}) {
...
class _$_FirebaseUser implements _FirebaseUser {
  const _$_FirebaseUser({required this.id, required this.firebaseUser});
  ...
  @override
  String toString() {
    return 'FirebaseUser(id: $id, firebaseUser: $firebaseUser)';
  }
...
abstract class _FirebaseUser implements FirebaseUser {
  const factory _FirebaseUser(
      {required UniqueId id, required User firebaseUser}) = _$_FirebaseUser;
